...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    ...
    Future.microtask(() => context
      ..read<MovieDetailBloc>().add(FetchMovieDetail(widget.id))
      ..read<MovieRecommendationBloc>().add(FetchMovieRecommendation(widget.id))
      ..read<WatchlistMovieBloc>().add(LoadWatchlistMovieStatus(widget.id)));
  }
                                ...
                                return ElevatedButton(
                                  onPressed: () {
                                    if (state.status) {
                                      ...
                                      const message = WatchlistMovieBloc
